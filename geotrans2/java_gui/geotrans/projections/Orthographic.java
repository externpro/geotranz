 ...
 * Orthographic.java
 *
 * Created on April 10, 2001, 12:53 PM
 */
 ...
 * @version 
 */
public class Orthographic extends Object {
    ...
    /** Creates new Orthographic */
    public Orthographic() {
    }

    public Orthographic(double olat, 
                        double cent_merid,
                        double feast,
                        double fnorth) 
    {
    ...
    public Orthographic(double east, 
                        double north) 
    {
        easting = east;
        northing = north;
