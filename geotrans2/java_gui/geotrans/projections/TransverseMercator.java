 ...
 *
 * Created on April 10, 2001, 1:01 PM
 */
 ...
 * @version 
 */
public class TransverseMercator extends Object {
    ...
    /** Creates new TransverseMercator */
    public TransverseMercator() {
    }

    public TransverseMercator(double olat, 
                              double cent_merid,
                              double scale_fact,
                              double feast,
                              double fnorth) 
    ...
    public TransverseMercator(double east, 
                              double north) 
    {
        easting = east;
        northing = north;
