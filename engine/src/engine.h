...
/* Engine return status codes */
  #define ENGINE_INPUT_WARNING               0x000000001    /* Warning returned by 1st conversion */
  #define ENGINE_INPUT_ERROR                 0x000000002    /* Error returned by 1st conversion */
  #define ENGINE_OUTPUT_WARNING              0x000000004    /* Warning returned by 2nd conversion */
  #define ENGINE_OUTPUT_ERROR                0x000000008    /* Error returned by 2nd conversion */
/* Initialization errors */
  #define ENGINE_NOT_INITIALIZED             0x000000010    /* Initialize_Engine has not been called */ 
  #define ENGINE_ELLIPSOID_ERROR             0x000000020    /* Error returned by Ellipsoid module */
  #define ENGINE_DATUM_ERROR                 0x000000040    /* Error returned by Datum module */
  #define ENGINE_GEOID_ERROR                 0x000000080    /* Error returned by Geoid module*/
  #define ENGINE_DATUM_FILE_PARSE_ERROR      0x000000100    /* Unable to read datum file */
  #define ENGINE_GEOID_FILE_PARSE_ERROR      0x000000200    /* Unable to read geoid file */
/* Interface parameter errors (should never occur) */
  #define ENGINE_INVALID_TYPE                0x000000400    /* Invalid coordinate system type */
  #define ENGINE_INVALID_DIRECTION           0x000000800    /* Invalid direction (input or output) */
  #define ENGINE_INVALID_STATE               0x000001000    /* Invalid state (interactive or file) */
/* Lookup table errors */
  #define ENGINE_INVALID_INDEX_ERROR         0x000002000    /* Index is an invalid value */
  #define ENGINE_INVALID_CODE_ERROR          0x000004000    /* Code was not found in table */
  #define ENGINE_ELLIPSOID_OVERFLOW          0x000008000    /* Ellipsoid table overflow */
  #define ENGINE_DATUM_OVERFLOW              0x000010000    /* 3-parameter datum table overflow */
/* Datum definition errors */
  #define ENGINE_DATUM_SIGMA_ERROR           0x000020000    /* Standard error values must be positive
                                                               (or -1 if unknown) */
  #define ENGINE_DATUM_DOMAIN_ERROR          0x000040000    /* Invalid local datum domain of validity */
/* Ellipsoid errors */
  #define ENGINE_ELLIPSE_IN_USE_ERROR        0x000080000    /* Ellipsoid code is in use by a datum */

/* Datum, ellipsoid deletion error */   
  #define ENGINE_NOT_USERDEF_ERROR           0x000100000    /* Specified code is not user defined */

/* Input/Output conversion status codes */
  #define ENGINE_ORIGIN_LAT_ERROR            0x000000001    /* Invalid Origin Latitude */
  #define ENGINE_CENT_MER_ERROR              0x000000002    /* Invalid Central Meridian */
  #define ENGINE_EASTING_ERROR               0x000000004    /* Invalid Easting */
  #define ENGINE_NORTHING_ERROR              0x000000008    /* Invalid Northing */
  #define ENGINE_RADIUS_ERROR                0x000000010    /* Point too far from center of projection */
  #define ENGINE_HEMISPHERE_ERROR            0x000000020    /* Invalid Hemisphere */                                           
  #define ENGINE_SCALE_FACTOR_ERROR          0x000000040    /* Invalid Scale Factor */
  #define ENGINE_LON_WARNING                 0x000000080    /* Longitude too far from Central Meridian */
  #define ENGINE_LAT_WARNING                 0x000000100    /* Longitude too far from Central Meridian */
  #define ENGINE_ORIGIN_LON_ERROR            0x000000200    /* Invalid Origin Longitude */
  #define ENGINE_DATUM_WARNING               0x000000400    /* Point outside datum validity rectangle */
/* Lambert/Albers error conditions */
  #define ENGINE_FIRST_STDP_ERROR            0x000000800    /* Invalid 1st Standard Parallel */
  #define ENGINE_SECOND_STDP_ERROR           0x000001000    /* Invalid 2nd Standard Parallel */
  #define ENGINE_FIRST_SECOND_ERROR          0x000002000    /* 1st & 2nd Standard Parallel cannot be same */
/* UTM/UPS/MGRS specific error conditions */
  #define ENGINE_ZONE_ERROR                  0x000004000    /* Invalid UTM Zone */
  #define ENGINE_ZONE_OVERRIDE_ERROR         0x000008000    /* Invalid UTM zone Override */
/* MGRS, GEOREF, British National Grid error condition */
  #define ENGINE_STRING_ERROR                0x000010000    /* Invalid MGRS, GARS, GEOREF or BNG String */
/* GEOREF specific error conditions */
  #define ENGINE_STR_LON_MIN_ERROR           0x000020000    /* GEOREF string long. min. error */
  #define ENGINE_STR_LAT_MIN_ERROR           0x000040000    /* GEOREF string lat. min. error */
/* Equidistant Cylindrical/Lambert_1 error condition */   
  #define ENGINE_STDP_ERROR                  0x000080000    /* Standard parallel error */
/* Azimuthal Equidistant error condition */
  #define ENGINE_PROJECTION_ERROR            0x000100000    /* Point projects into a circle of radius PI*R */
/* Oblique Mercator error conditions */
  #define ENGINE_LAT1_ERROR                  0x000200000    /* Invalid 1st Latitude */
  #define ENGINE_LON1_ERROR                  0x000400000    /* Invalid 1st Longitude */
  #define ENGINE_LAT2_ERROR                  0x000800000    /* Invalid 2nd Latitude */
  #define ENGINE_LON2_ERROR                  0x001000000    /* Invalid 2nd Longitude */
  #define ENGINE_LAT1_LAT2_ERROR             0x002000000    /* 1st & 2nd Latitudes cannot be equal */
/* British National Grid error condition */
  #define ENGINE_INVALID_AREA_ERROR          0x004000000    /* Coordinate outside BNG grid */
/* British National Grid, New Zealand Map Grid error condition */
  #define ENGINE_ELLIPSOID_CODE_ERROR        0x008000000    /* Invalid ellipsoid */


/* Common status codes */
  #define ENGINE_NO_ERROR                    0x000000000    /* no error */ 
  #define ENGINE_LAT_ERROR                   0x010000000    /* Invalid Latitude */
  #define ENGINE_LON_ERROR                   0x020000000    /* Invalid Longitude */
  #define ENGINE_A_ERROR                     0x040000000    /* Invalid Ellipsoid Semi-Major Axis */
  #define ENGINE_INV_F_ERROR                 0x080000000    /* Invalid Inverse Flattening */

//  #define ENGINE_DATUM_ROTATION_ERROR        3    /* Invalid rotation x, y or z*/
//  #define ENGINE_DATUM_SCALE_ERROR           5    /* Invalid scale */

#ifdef WIN32
    #define ENGINE_PRECISION_ERROR           0x100000000    /* Invalid precision */
#else
    #define ENGINE_PRECISION_ERROR           0x100000000LL  /* Invalid precision */
#endif



/* Symbolic constants */   
  #define NUMBER_COORD_SYS                   35  /* Number of coordinate systems        */
...
/* GARS Coordinate Tuple Definition */
typedef struct GARS_Tuple_Structure
{
  char    string[8];
} GARS_Tuple;
...
/* Lambert Conformal Conic (1 parallel) System Definition */
...
/* Lambert Conformal Conic (1 parallel) Coordinate Tuple Definition */
...
/* Lambert Conformal Conic (2 parallel) System Definition */
typedef struct Lambert_Conformal_Conic_2_Structure
{
  double  origin_latitude;   /* radians */
  double  central_meridian;  /* radians */
  double  std_parallel_1;    /* radians */
...
/* Lambert Conformal Conic (2 parallel) Coordinate Tuple Definition */
typedef struct Lambert_Conformal_Conic_2_Tuple_Structure
{
  double  easting;     /* meters */
  double  northing;    /* meters */
...
/* USNG Coordinate Tuple Definition */
typedef struct USNG_Tuple_Structure
{
  char    string[21];
} USNG_Tuple;
